...
const DeleteCategoryDrawer = ({ userProfile, open, handleClose, fetchData, category, languages, page, pageSize, showSuccessMessage }: Props) => {
  ...
  const handleDeleteSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!categoryId || !imageId) {
      console.error('Category ID or Image ID is missing');
