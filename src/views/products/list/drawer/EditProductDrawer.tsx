...
import SubcategoryFilters from "src/views/products/list/filter/SubcategoryFilters";
...
// Types Imports
import {FormDataType} from "src/@core/types/products/types";
...
const EditProductDrawer = ({
  ...
  const initialData: FormDataType = Object.fromEntries(
    languages.map((lang) => [
      lang.language_code,
      {lang_code: lang.language_code, content: {title: '', description: ''}},
    ])
  );
