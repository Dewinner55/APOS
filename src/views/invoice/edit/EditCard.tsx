...
import AppReactDatepicker from "src/@core/styles/libs/AppReactDatepicker";
...
const EditCard = ({ userProfile, order, languages }: Props) => {
  const invoiceData = {
  ...
  // States
  const [selectData, setSelectData] = useState<InvoiceType>()
              ...
              <div className='flex justify-between flex-col gap-4 sm:flex-row'>
                <div className='flex flex-col gap-4 order-2 sm:order-[unset]'>
                  <div className='flex items-center gap-2'>
                    ...
                    <TextField size='small' defaultValue='Valentin Krivich' />
                  </div>
