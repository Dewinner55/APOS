...
export async function updateUserTheme({ cookies, referer, newTheme }: UserProfileUpdateParams): Promise<UserProfileResponse> {
  const axiosConfig = {
    headers: {
      'Referer': referer,
      'Cookie': cookies
...
export async function updateUserLanguage({ cookies, referer, newSystemLanguage  }: UserProfileUpdateParams): Promise<UserProfileResponse> {
  const axiosConfig = {
    headers: {
      'Referer': referer,
      'Cookie': cookies
