  ...
  return (
    <Dialog fullWidth open={open} onClose={handleReset} maxWidth='md' scroll='body'>
      ...
      >
        ...
        <Box sx={{mt: 2}}>
          <Typography component='span' className='flex flex-col text-center'>
            Удаление сведений о категории будет подвергнуто аудиту конфиденциальности.
            Удаление в свою очередь удалят все языковые переводы.
          </Typography>
        </Box>
        <IconButton
          onClick={handleReset}
      ...
      <Dialog open={submitSuccess} onClick={handleCategoryList}>
        ...
        <DialogContent>
          <DialogContentText>Данные успешно удалены.</DialogContentText>
        </DialogContent>
        <DialogActions>
